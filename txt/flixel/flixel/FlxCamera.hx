...
class FlxCamera extends FlxBasic
{
	 ...
	 */
	public var _scrollTarget:FlxPoint = FlxPoint.get();
	public static var no_shake:Bool = false;
	public var only_lerp_y:Bool = false;
	/**
	 * Internal, used to control the "fade" special effect.
	 */
	...
	public function updateFollow():Void
	{
		...
		else
		{
			...
			//if (followLerp >= 60 / FlxG.updateFramerate || followLerp == 0)
			//{
