...
* @param o
* @param screenSpace is the check done in screenspace (default yep)
* @param camera
* @return
*/
public function inside(o:FlxObject, camera:FlxCamera = null):Bool {
if (camera == null) {
var fp:FlxPoint = o.getScreenPosition();
var sx:Int = Math.floor(fp.x);
var sy:Int = Math.floor(fp.y);
if (screenX >= sx && screenX <= sx+ o.width && screenY <= sy + o.height && screenY >= sy) {
return true;
}
}
return false;
