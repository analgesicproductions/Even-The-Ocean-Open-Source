...
outname = "D:/output/"+str(random.randint(100,999))+str(random.randint(100,999))+str(random.randint(100,999))+".png"
print outname
...
while True:
	...
	x_start = random.randint(0,w-chunk_w)
	y_start = random.randint(0,h-chunk_h)
